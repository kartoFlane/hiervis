...
public class HVConstants
{
	...
	public static final String PREFUSE_NUMBER_OF_INSTANCES_COLUMN_NAME = "InstanceCount";
	public static final String PREFUSE_NODE_ROLE_COLUMN_NAME = "Role";
	public static final String PREFUSE_NODE_LABEL_COLUMN_NAME = "Label";

	public static final String NAME_OF_HIERARCHY = "Hierarchy";
